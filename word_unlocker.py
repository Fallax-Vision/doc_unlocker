#!/usr/bin/env python3
"""
Word Unlocker - Password Recovery
=================================
...
Project: https://github.com/Fallax-Vision/word_unlocker
License: MIT
"""
...
def write_log(folder, doc_path, password, tries, out_path):
    log_path = os.path.join(folder, "WordUnlocker_found.log")
    ...
    def _export_gpu_worker(self, doc_path, wordlist, mut, two, dates):
        try:
            ...
            with open(bat_path, "w", encoding="utf-8") as f:
                f.write(
                    "@echo off\r\n"
                    "REM Auto-generated by Word Unlocker - GPU crack (-m 9600)\r\n\r\n"
